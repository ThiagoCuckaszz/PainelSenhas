  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <button
          className="btn_inciais"
          onClick={() => handleButtonClick("preventivo")}
        >
          PREVENTIVO
        </button>
        <button
          className="btn_laboratoriais"
          onClick={() => handleButtonClick("exames-laboratoriais")}
        >
          EXAMES LABORATORIAIS
        </button>
        <button
          className="btn_laboratoriais"
          onClick={() => handleButtonClick("exames-nao-laboratoriais")}
        >
